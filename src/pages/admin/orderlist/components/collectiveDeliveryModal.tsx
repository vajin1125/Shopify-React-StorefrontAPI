...
export const CollectiveDeliveryModal = ({
  open,
  handleOpen,
}: {
  open: boolean
  ...
  return (
    <Modal handleClose={handleClose} open={open} title="admin.orderlist.collective_delivery">
      <Box mt={3} py={3} px={10}>
        ...
        <InputField label="admin.orderlist.date_of_receipt">
          <Date
            value="01/23/2023"
            onChange={(val, key) => {
              console.log(val, key)

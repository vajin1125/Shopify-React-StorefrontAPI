...
interface PrimaryCreditCardConfirmDialogProps {
  open: boolean
  setOpen: Function
  creditCard: ICard | null
}

export const PrimaryCreditCardConfirmDialog: React.FC<PrimaryCreditCardConfirmDialogProps> = ({
  open,
  setOpen,
  creditCard,
}) => {
  ...
  const handleUpdatePaymentMethod = () => {
    updateDefaultPaymentMethod({
      ...
      defaultCardId: creditCard?.paymentMethodId || "",
    ...
    >
      <Box sx={{ bgcolor: "background.default", px: 3, py: 3.5 }}>
        ...
        <Typography.SubTitle sx={{ color: "text.primary", textAlign: "center", mb: 3 }}>
          {t("mypage.set_as_primary_credit_card")}
        </Typography.SubTitle>
